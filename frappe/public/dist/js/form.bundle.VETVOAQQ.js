(() => {
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/address_list.html
  frappe.templates["address_list"] = `<p>
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/contact_list.html
  frappe.templates["contact_list"] = `<p>
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_dashboard.html
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_footer.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_links.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_sidebar.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/print_layout.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/report_links.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/set_sharing.html
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/timeline_message_box.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/users_in_sidebar.html
...
`;
  ...
  // frappe/public/js/frappe/views/render_preview.js
  ...
  frappe.ui.form.QuickEntryForm = class QuickEntryForm extends frappe.ui.Dialog {
    ...
    has_child_table() {
      if ($.map(this.docfields, function(d) {
    ...
    insert() {
      ...
      return new Promise((resolve) => {
        ...
        frappe.call({
          ...
          callback: function(r) {
            var _a;
            if (((_a = r == null ? void 0 : r.message) == null ? void 0 : _a.docstatus) === 0 && frappe.model.can_submit(me.doctype) && !frappe.model.has_workflow(me.doctype)) {
              frappe.run_serially([
                () => me.dialog.working = true,
                () => {
    ...
    render_edit_in_full_page_link() {
      if (this.force || this.hide_full_form_button)
        return;
  ...
  frappe.ui.form.Toolbar = class Toolbar {
    ...
    is_title_editable() {
      ...
      if (this.frm.meta.naming_rule === "By fieldname" && this.frm.meta.autoname === "field:" + title_field && !this.frm.meta.allow_rename) {
        return false;
      }
      if (title_field && this.frm.perm[0].write && !this.frm.doc.__islocal && doc_field.fieldtype === "Data" && !doc_field.read_only && !doc_field.set_only_once) {
        return true;
      } else {
        return false;
      }
    ...
    set_indicator() {
      ...
      if (this.frm.save_disabled && indicator && [
    ...
    add_print() {
      ...
      if (!frappe.model.is_submittable(this.frm.doc.doctype) || this.frm.doc.docstatus == 1 || allow_print_for_cancelled && this.frm.doc.docstatus == 2 || allow_print_for_draft && this.frm.doc.docstatus == 0) {
    ...
    add_delete() {
      if (cint(this.frm.doc.docstatus) != 1 && !this.frm.doc.__islocal && !frappe.model.is_single(this.frm.doctype) && frappe.model.can_delete(this.frm.doctype)) {
        this.page.add_menu_item(
          __("Delete"),
          () => {
            this.frm.savetrash();
    ...
    refresh_follow(follow) {
      var _a;
      (_a = this.follow_menu_item) == null ? void 0 : _a.text(this.get_follow_text(follow));
    }
  };
  ...
  frappe.ui.form.Dashboard = class FormDashboard {
    ...
    set_badge_count_common(open_count, count, $link) {
      if (open_count) {
        $link.find(".open-notification").removeClass("hidden").html(cint(open_count) > 99 ? "99+" : open_count);
      }
      if (count) {
        $link.find(".count").removeClass("hidden").text(cint(count) > 99 ? "99+" : count).attr(
          "title",
          count != "?" ? __("Count of linked documents") : __("Accurate count can not be fetched, click here to view all documents")
        );
      }
    }
    update_heatmap(data) {
...
${this.frm.doctype_layout.client_script}`;
  ...
  window.set_field_options = function(n, txt) {
    cur_frm == null ? void 0 : cur_frm.set_df_property(n, "options", txt);
  };
  ...
  frappe.ui.form.AssignmentDialog = class {
    ...
    get_assignment_row(assignment) {
      ...
      if (assignment === frappe.session.user) {
        ...
        const html = this.assignment_details.filter((x) => x.owner === assignment && strip_html(x.description)).map((x) => x.description).join("<hr>");
        if (html) {
          $(
            "<div class='small overflow-auto m-1 p-1 flex-grow-1' style='max-height: 100px;'>"
          ).html(html).appendTo(row);
        }
      }
  ...
  frappe.ui.form.Attachments = class Attachments {
    ...
    add_attachment(attachment) {
      ...
      $(`<div class="attachment-row"></div>`).append(frappe.get_data_pill(file_label, fileid, remove_action, icon)).insertAfter(this.add_attachment_wrapper);
    }
  ...
  function get_version_timeline_content(version_doc, frm) {
      ...
      data.changed.every(function(p) {
        if (p[0] === "docstatus") {
          ...
          if (df && (!df.hidden || df.show_on_timeline)) {
            ...
            if (field_display_status === "Read" || field_display_status === "Write" || df.hidden && df.show_on_timeline) {
              parts.push(
                __("{0} from {1} to {2}", [
    ...
    if (audit_user) {
      ...
      out = out.map((message) => `${message} \xB7 ${audit_msg.bold()}`);
    }
    return out;
  }
  ...
  frappe.ui.form.Sidebar = class {
    ...
    refresh_web_view_count() {
      if (this.frm.doc.route && cint(frappe.boot.website_tracking_enabled)) {
        ...
        frappe.utils.get_page_view_count(route).then((res) => {
          this.sidebar.find(".pageview-count").removeClass("hidden").html(__("{0} Web page views", [String(res.message).bold()]));
        });
      }
    }
    refresh_creation_modified() {
      ...
      let creation_message = get_user_message(
        this.frm.doc.owner,
        __("You created this", null),
        __("{0} created this", [get_user_link(this.frm.doc.owner)])
      ) + " \xB7 " + cint(frappe.boot.user.show_absolute_datetime_in_timeline) || cint(frappe.boot.sysdefaults.show_absolute_datetime_in_timeline) ? frappe.datetime.str_to_user(this.frm.doc.creation) : comment_when(this.frm.doc.creation);
      let modified_message = get_user_message(
        this.frm.doc.modified_by,
        __("You last edited this", null),
        __("{0} last edited this", [get_user_link(this.frm.doc.modified_by)])
      ) + " \xB7 " + cint(frappe.boot.user.show_absolute_datetime_in_timeline) || cint(frappe.boot.sysdefaults.show_absolute_datetime_in_timeline) ? frappe.datetime.str_to_user(this.frm.doc.modified) : comment_when(this.frm.doc.modified);
    ...
    get_timeline_item(item) {
      ...
      if (!item.hide_timestamp && !item.is_card) {
        timeline_content.append(
          `<span> \xB7 ${cint(frappe.boot.user.show_absolute_datetime_in_timeline) || cint(frappe.boot.sysdefaults.show_absolute_datetime_in_timeline) ? frappe.datetime.str_to_user(item.creation) : comment_when(item.creation)}</span>`
        );
      }
      if (item.id) {
  ...
  var FormTimeline = class extends base_timeline_default {
    ...
    add_dropdown_item(timeline_box, menu_items) {
      ...
      menu_items.forEach((m) => {
        ...
        let formatted_action_name = String(action_name).charAt(0).toUpperCase() + String(action_name).slice(1);
        m.empty();
        m.append(
    ...
    update_comment_publicity(comment_name, publish) {
      ...
      frappe.confirm(message, () => {
        return frappe.xcall("frappe.desk.form.utils.update_comment_publicity", {
          name: comment_name,
          publish
        }).then(() => {
          frappe.utils.play_sound("click");
  ...
  frappe.ui.form.Footer = class FormFooter {
    ...
    refresh_comments_count() {
      ...
      (_a = this.wrapper.find(".comment-count")) == null ? void 0 : _a.html(count ? `(${count})` : "");
    }
    make_like() {
  ...
  frappe.ui.form.Form = class FrappeForm {
    ...
    is_form_builder() {
      return ["DocType", "Customize Form"].includes(this.doctype) && this.get_active_tab().label == "Form";
    }
    ...
    set_active_tab(tab) {
      var _a, _b, _c, _d, _e;
      const previous_tab_name = ((_c = (_b = (_a = this.active_tab_map) == null ? void 0 : _a[this.docname]) == null ? void 0 : _b.df) == null ? void 0 : _c.fieldname) || "";
      const next_tab_name = ((_d = tab == null ? void 0 : tab.df) == null ? void 0 : _d.fieldname) || "";
      const has_changed = previous_tab_name !== next_tab_name;
      if (!has_changed) {
        return;
      }
      (_e = this.active_tab_map) != null ? _e : this.active_tab_map = {};
      ...
      for (const df of this.layout.fields) {
        ...
        if ((df == null ? void 0 : df.fieldtype) == "Tab Break") {
          in_tab = df === (tab == null ? void 0 : tab.df);
        } else if (typeof (field == null ? void 0 : field.on_section_collapse) == "function") {
...
//# sourceMappingURL=form.bundle.VETVOAQQ.js.map
