    ...
    function get_updated_transitions() {
      ...
      actions.forEach((action) => {
        ...
        let state = states.find(
          (state2) => state2.data.workflow_builder_id == action.data.from_id
        );
        let next_state = states.find(
          (state2) => state2.data.workflow_builder_id == action.data.to_id
        );
        if (action.data.to.length === 0 && next_state != void 0) {
...
Edge: ${id2}`
      ...
      $props.markerEnd == "url(#)" ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createBlock)($setup["EdgeLabelRenderer"], { key: 0 }, {
        default: (0, vue_runtime_esm_bundler_exports.withCtx)(() => [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
            ...
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__($props.targetNode.data.allowed)), 1)
          ], 4)
        ]),
        _: 1
  ...
  function render2(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      ...
      $setup.label ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_13, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__($setup.label)), 1)) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_22, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("No Label")), 1)),
  ...
  function render3(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      ...
      $setup.label ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_14, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__($setup.label)), 1)) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_23, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("No Label")), 1)),
      ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(["top", "right", "bottom", "left"], (handle) => {
        return (0, vue_runtime_esm_bundler_exports.createVNode)($setup["Handle"], {
          class: "handle",
      ...
      let properties = (0, vue_runtime_esm_bundler_exports.computed)(() => {
        ...
        if (store.workflow.selected && "action" in store.workflow.selected.data) {
          ...
          return store.transitionfields.filter(
            (df) => ["action", "allowed", "allow_self_approval", "condition"].includes(df.fieldname)
          );
          ...
          default: (0, vue_runtime_esm_bundler_exports.withCtx)(() => [
            ...
            (0, vue_runtime_esm_bundler_exports.createVNode)($setup["Panel"], {
              ...
              default: (0, vue_runtime_esm_bundler_exports.withCtx)(() => [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_33, [
                  ...
                  }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Drag to add state")), 33)
                ])
              ]),
              _: 1
            }, 8, ["position"]),
            (0, vue_runtime_esm_bundler_exports.createVNode)($setup["Panel"], {
              ...
              default: (0, vue_runtime_esm_bundler_exports.withCtx)(() => [
                ...
                }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Fit")), 1)
              ]),
              _: 1
            }, 8, ["position"])
          ]),
  ...
  function render10(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      ...
      $setup.slots.label ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("label", _hoisted_19, [
        ...
        }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__($props.df.label)), 3)
      ])),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" description "),
      $props.df.description ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
        key: 2,
        class: "mt-2 description",
        innerHTML: _ctx.__($props.df.description)
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      (0, vue_runtime_esm_bundler_exports.watch)(
        ...
        (value) => {
          ...
          (_a2 = code_control.value) == null ? void 0 : _a2.set_value(value != null ? value : "");
        }
      );
      (0, vue_runtime_esm_bundler_exports.watch)(
        () => props.df.max_height,
  ...
  function render12(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      ...
      $setup.slots.label ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("input", {
        ...
        placeholder: _ctx.__($setup.placeholder),
        readonly: ""
  ...
  var useStore2 = defineStore("form-builder-store", () => {
    ...
    async function fetch() {
      ...
      if (doctype.value.startsWith("new-doctype-") && !((_a2 = doc.value.fields) == null ? void 0 : _a2.length)) {
  ...
  var TableControl_default = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { props, get table_columns() {
        ...
        table_columns = v;
      }, open_new_child_doctype_dialog, get get_table_columns() {
  ...
  function render19(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_118, [
      ...
      $props.df.fieldtype == "Table" ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_315, [
        ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.table_columns, ([tf, size], i) => {
          return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
            ...
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_413, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__(tf.label)), 1)
          ], 4);
        }), 128))
      ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_56, [
        ...
        (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" render this button when there are no columns, which means that options is not added for the table "),
        !$setup.table_columns.length ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("button", {
          key: 0,
          class: "btn btn-xs btn-secondary",
          onClick: $setup.open_new_child_doctype_dialog
        }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Create Child Doctype")), 1)) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("p", _hoisted_72, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("No Data")), 1))
      ]),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" description "),
      $props.df.description ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
        key: 1,
        class: "mt-2 description",
        innerHTML: _ctx.__($props.df.description)
      }, null, 8, _hoisted_82)) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
    ]);
  }
  ...
  function render20(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      ...
      $setup.slots.label ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_119, [
        (0, vue_runtime_esm_bundler_exports.renderSlot)(_ctx.$slots, "label"),
        (0, vue_runtime_esm_bundler_exports.renderSlot)(_ctx.$slots, "actions")
      ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_218, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__($props.df.label)), 1)),
 ...
 */
/*! #__NO_SIDE_EFFECTS__ */
//# sourceMappingURL=workflow_builder.bundle.PYREEJLL.js.map
