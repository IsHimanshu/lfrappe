(() => {
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/listing.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/filters/edit_filter.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/html/print_template.html
...
`;
  ...
  var FilterArea = class {
    ...
    toggle_standard_filter() {
      ...
      this.$filter_list_wrapper.find(".filter-toggle").find("use").attr("href", `#icon-${icon_name}`);
    }
    setup() {
    ...
    async make_standard_filters() {
      ...
      fields = fields.concat(
        doctype_fields.filter(
          (df) => (df.fieldname === title_field || df.in_standard_filter && frappe.model.is_value_type(df.fieldtype)) && frappe.perm.has_perm(this.list_view.doctype, df.permlevel)
        ).map((df) => {
    ...
    get_header_html() {
      ...
      const $columns = this.columns.map((col) => {
        ...
        if (col.type === "Subject") {
          ...
          const fieldname = (_a3 = col.df) == null ? void 0 : _a3.fieldname;
  ...
  frappe.views.ListSidebar = class ListSidebar {
    ...
    add_crm_banner() {
      ...
      const message = "";
      const link = "https://frappe.io/crm?utm_source=crm-sidebar&utm_medium=sidebar&utm_campaign=frappe-ad";
    ...
    add_helpdesk_banner() {
      ...
      const message = "";
      const link = "https://frappe.io/helpdesk?utm_source=support-sidebar&utm_medium=sidebar&utm_campaign=frappe-ad";
      const cta = __("Upgrade your support experience with Frappe Helpdesk");
      this.add_banner(message, link, cta);
    }
  };

  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar_stat.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_view_permission_restrictions.html
...
`;
  ...
  frappe.views.Calendar = class Calendar {
    ...
    bind() {
      ...
      btn_group.on("click", ".btn", function() {
        let value = $(this).hasClass("fc-dayGridWeek-button") ? "dayGridWeek" : $(this).hasClass("fc-dayGridDay-button") ? "dayGridDay" : "dayGridMonth";
    ...
    set_css() {
      const viewButtons = ".fc-dayGridMonth-button, .fc-dayGridWeek-button, .fc-dayGridDay-button, .fc-today-button";
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/image_view_item_row.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/photoswipe_dom.html
...
`;
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_board.html
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_column.html
  ...
  // frappe-html:/home/frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_card.html
